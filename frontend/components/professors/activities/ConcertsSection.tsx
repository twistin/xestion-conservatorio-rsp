...
const ConcertsSection: React.FC = () => {
  ...
  return (
    <div className="ia-block p-6 rounded-lg shadow mb-6">
      <h2 className="text-xl font-bold mb-4">Conciertos y Recitales</h2>
      <p>Gestión de calendario, salas, inscripciones y material promocional para conciertos y recitales.</p>
      <ActivityForm type="Concierto o Recital" onSubmit={handleAdd} />
      <div className="mt-6">
        <h4 className="font-bold mb-2">Próximos conciertos/recitales</h4>
        {loading ? (
