...
const CompetitionsSection: React.FC = () => {
  ...
  return (
    <div className="ia-block p-6 rounded-lg shadow mb-6">
      <h2 className="text-xl font-bold mb-4">Concursos y Certámenes</h2>
      <p>Anuncios, inscripciones, resultados y galería de ganadores.</p>
      <ActivityForm type="Concurso o Certamen" onSubmit={handleAdd} />
      <div className="mt-6">
        <h4 className="font-bold mb-2">Próximos concursos/certámenes</h4>
        {loading ? (
